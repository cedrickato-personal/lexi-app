...
export const LANGUAGES: Record<string, LanguageMeta> = {
  ...
  // ── FSI Category III — 150-170 weeks ────────────────────────
  ...
  tl:  { code: 'tl',  name: 'Filipino',    nativeName: 'Filipino',     fsiCategory: 3, totalWeeks: 170, family: 'Austronesian', familyLabel: 'Austronesian → Malayo-Polynesian', script: 'Latin',          rtl: false, notes: 'Tagalog-based.' },
  ceb: { code: 'ceb', name: 'Cebuano',     nativeName: 'Sinugboanon',  fsiCategory: 3, totalWeeks: 170, family: 'Austronesian', familyLabel: 'Austronesian → Malayo-Polynesian', script: 'Latin',          rtl: false },
  ...
  ga:  { code: 'ga',  name: 'Irish',       nativeName: 'Gaeilge',      fsiCategory: 3, totalWeeks: 170, family: 'Celtic',      familyLabel: 'Indo-European → Celtic',      script: 'Latin',                  rtl: false },

  // ── FSI Category IV — 180-200 weeks ─────────────────────────
  zh: { code: 'zh', name: 'Mandarin',  nativeName: '中文',     fsiCategory: 4, totalWeeks: 200, family: 'Sino-Tibetan', familyLabel: 'Sino-Tibetan → Sinitic',     script: 'Simplified Chinese',         rtl: false, notes: 'Putonghua, simplified characters.' },
  ...
  ko: { code: 'ko', name: 'Korean',    nativeName: '한국어',    fsiCategory: 4, totalWeeks: 200, family: 'Koreanic',     familyLabel: 'Koreanic',                    script: 'Hangul',                      rtl: false },
  ...
  th: { code: 'th', name: 'Thai',      nativeName: 'ภาษาไทย',  fsiCategory: 4, totalWeeks: 200, family: 'Tai-Kadai',    familyLabel: 'Tai-Kadai → Tai',             script: 'Thai',                        rtl: false },
};
